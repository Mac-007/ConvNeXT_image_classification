"""
Validation script for the ConvNeXT image classification project.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Validate ConvNeXT image classifier')
    parser.add_argument(
        '--config',
        type=str,
